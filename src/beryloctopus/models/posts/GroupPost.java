...
public class GroupPost extends Post {
    ...
    public GroupPost(String title, String path, UUID authorUUID, byte[] rawPostContent, long timestamp, PostRepository postRepository, UserRepository userRepository) {
